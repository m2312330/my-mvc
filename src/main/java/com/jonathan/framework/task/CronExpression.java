package com.jonathan.framework.task;
...
public class CronExpression {
	...
	static class DayOfWeekField extends BasicField {
		...
		@Override
		protected Integer mapValue(String value) {
			// Use 1-7 for weedays, but 0 will also represent sunday (linux
			// practice)
	...
	public String timeZonedToString(ZonedDateTime zonedDateTime) {
	...
	public Date timeZonedToDate(ZonedDateTime zonedDateTime) {
