package com.jonathan.framework.jdbc;
...
import com.jonathan.framework.jdbc.entity.JDBCEntity;
import com.jonathan.framework.jdbc.entity.Where;
import com.jonathan.framework.jdbc.util.JdbcUtil;
...
import com.jonathan.framework.jdbc.annotation.Column;
import com.jonathan.framework.jdbc.entity.Pager;
...
public class JdbcHandle {
	...
	public List<String> getPrimaryKeys(String tableName) {
		...
		try {
			...
			if (!StringUtil.isNullOrEmpty(primaryKeys)) {
				LocalCache.setCache(key, primaryKeys, 30);
			}
			return primaryKeys;
